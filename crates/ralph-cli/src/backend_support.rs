...
pub const VALID_BACKENDS_LABEL: &str = "claude, kiro, gemini, codex, amp, copilot, opencode, pi, custom";
...
pub fn unknown_backend_message(name: &str) -> String {
    format!("Unknown backend: {}\n\nValid backends: {}", name, VALID_BACKENDS_LABEL)
}
